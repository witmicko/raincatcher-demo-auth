...
describe('hash', function() {
  describe('#saltAndHash', function() {
    ...
    it('should also the cipher, iterations and salt', function(done) {
  ...
  describe('#verify', function() {
    it('should return true for a correct password', function(done) {
    ...
    it('should return true for a #saltAndHash-ed password', function(done) {
      hash.saltAndHash('Password1', function(err, hashed) {
        assert(!err);
